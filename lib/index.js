...
class InstaDP {
   ...
   * @param {string} username User to fetch data from
   * @returns {(string[]|string)} List of story media
   */
   ...
   * @param {string} username User to fetch data from
   * @returns {(string[]|string)} List of reel media
   */
 ...
 * @returns {string[]} List of reel video sources
 */
 ...
 * @param {any} fetcher Object to fetch data from an endpoint
 * @param {string} html Source HTML
 * @returns {(string[]|string)} List of reel sources
 */
